...
class PageAccount : RxPageFragment() {

    private val TAG = javaClass.simpleName

    @Inject
    lateinit var viewViewModelFactory: ViewModelFactory
    private lateinit var viewModel: PageAccountViewModel
    ...
    override fun onCreatedView() {
        ...
        viewModel = ViewModelProviders.of(this, viewViewModelFactory)[PageAccountViewModel::class.java]
