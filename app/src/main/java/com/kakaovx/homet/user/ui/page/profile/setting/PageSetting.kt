...
class PageSetting : RxPageFragment() {

    private val TAG = javaClass.simpleName

    @Inject
    lateinit var viewViewModelFactory: ViewModelFactory
    private lateinit var viewModel: PageSettingViewModel
    ...
    override fun onCreated() {
        ...
        viewModel = ViewModelProviders.of(this, viewViewModelFactory)[PageSettingViewModel::class.java]
