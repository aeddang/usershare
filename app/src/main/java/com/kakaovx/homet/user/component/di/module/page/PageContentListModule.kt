...
@Module
class PageContentListModule {

    @Provides
    @PageScope
    fun provideViewModelFactory(repository: Repository): PageContentListViewModelFactory
        = PageContentListViewModelFactory(repository)
}