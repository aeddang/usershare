...
class HomeFreeWorkoutModel(val id: String?,
                           val home_free_workout_description: String?,
                           val home_free_workout_title: String?,
                           val home_free_workout_url: String?) {
    override fun toString(): String {
        return "HomeFreeWorkoutModel(id = $id\n " +
                " home_free_workout_description=$home_free_workout_description\n" +
