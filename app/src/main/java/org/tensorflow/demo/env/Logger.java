...
public final class Logger {
    ...
    private static final String DEFAULT_TAG = "VX_tensorflow";
     ...
     * @param messagePrefix prepended to every message if non-null. If null, the name of the caller is being used
     */
     ...
     *
     * Android getStackTrace() returns an array that looks like this: stackTrace[0]: dalvik.system.VMStack stackTrace[1]:
     * java.lang.Thread stackTrace[2]: com.google.android.apps.unveil.env.UnveilLogger stackTrace[3]:
