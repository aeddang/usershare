...
public class ImageUtils {
    ...
    /**
     * Converts YUV420 semi-planar data to ARGB 8888 data using the supplied width and height. The input and output must
     * already be allocated and non-null. For efficiency, no error checking is performed.
     *
    ...
    /**
     * Converts YUV420 semi-planar data to RGB 565 data using the supplied width and height. The input and output must
     * already be allocated and non-null. For efficiency, no error checking is performed.
     *
     * @param input The array of YUV 4:2:0 input data.
    ...
    /**
     * Converts 32-bit ARGB8888 image data to YUV420SP data.  This is useful, for instance, in creating data to feed the
     * classes that rely on raw camera preview frames.
     *
    ...
    /**
     * Converts 16-bit RGB565 image data to YUV420SP data.  This is useful, for instance, in creating data to feed the
     * classes that rely on raw camera preview frames.
     *
